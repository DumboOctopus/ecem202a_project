...
* Potential Impact:
    It could help us to have a better understanding of the impact of the compression on the images, time for communicating and resulting classification. As a result, we could know how much compression should be applied to images to achieve certain accuracy and latency.
...
* Requirements for Success:
    We will need two Raspberry Pis. One is serving as a client that has a motor controller and a camera to take pictures. One is serving as a server to receive pictures, run the object detection model and send results back to the client. For client-server communication, we use HTTP as our communication protocol over Wi-Fi. For image compression, we have knowledge about different image compression strategies and we will need to find optimized algorithms for the ones which we evaluate.
...
<p align="center">
  <img src="media/image3.png" width="700" height="400"/>
</p>
<p align="center">
